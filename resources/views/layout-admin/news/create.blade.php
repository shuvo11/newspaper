                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal" action="{{URL::to('Save-news')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" id="first-name" class="form-control" name="news_title" placeholder="news_title" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1 row">
                                                    <div class="col-sm-3">
                                                        <label class="col-form-label" for="first-name">News Category</label>
                                                    </div>
                                                    <div class="col-sm-9">
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea name='news_short_description' class='form-control' ></textarea>
                                                    </div>
                                                </div>
                                            </div>
